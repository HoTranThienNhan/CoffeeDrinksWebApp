...
<main>
    ...
    <?php
        ...
        <div class="row table-product">
            ...
            <td class="col-4"> <a href="/detail?masp=' . $item->ma_san_pham . '""><img src="/img/product/';
                        echo  $item->hinh_anh . '" width="40%" ></a>';
                        $total = $total + $item['gia_khuyen_mai'] * $item['so_luong_san_pham'];
            ...
            <input type="hidden" name="masp" value="' . $item->ma_san_pham . '">
             <button class="btn btn-link"><i class="fa fa-minus-circle" style="color:#ec4276; font-size:24px;"></i></button></form><input type="number" style="width:60px;" class="text-center" value = "' . $item['so_luong_san_pham'] . '"/><form  action="/addCart" method="POST"><input type="hidden" value="1"  name="so-luong">
            <input type="hidden" name="masp" value="' . $item->ma_san_pham . '">
             <button class="btn btn-link"><i class="fa fa-plus-circle" style="color:#ec4276; font-size:24px;"></i></button></form></td>
            <td>' . number_format($item['gia_khuyen_mai'] * $item['so_luong_san_pham'], 0, '.', ',')  . ' VNĐ</td>
            <td><a href="/delCart?masp=' . $item['ma_san_pham'] . '"><button class="btn btn-danger text-light"><i class="fas fa-trash-alt"></i></button></td></a>
        </tr>
