        ...
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-4 text-primary"><span class="text-secondary">hi</span>COFFEE</h1>
                </a>
                <p>Cà phê tuyệt hảo từ khắp nơi trên thế giới. Chúng tôi mong muốn mang tới cho bạn những sản phẩm này.</p>
            ...
            <div class="col-lg-8 col-md-12 mt-3">
                <div class="row">
                    ...
                    <div class="col-md-4 mt-5">
                        <img src="/img/check-footer.png" height="150px" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-lg-left">
                    &copy; <a class="font-weight-semi-bold" href="#">Highlight Coffee</a>. Dự án báo cáo học phần CT27502.
                    Thiết kế và cài đặt bởi B2005780 & B2005767
                </p>
            </div>
