            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center text-lg-right">
                    <div class="d-inline-flex align-items-center">
                        <form method="POST" class="search-box" action="/search" name="search-form">
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light shadow p-lg-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="/product" class="nav-item nav-link <?= ($activePage == 'product') ? 'active' : ''; ?>">Sản phẩm</a>
                    </div>
                    <a href="/home" class="navbar-brand mx-5 d-none d-lg-block">
                        <h2 class="m-0 display-4 text-primary"><span class="text-secondary">hi</span>COFFEE</h2>
                    </a>
