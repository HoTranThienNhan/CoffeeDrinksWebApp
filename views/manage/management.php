            ...
            <tbody>
                <?php foreach ($products_manage as $product_manage) : ?>
                    <tr style="font-size: 15px;">
                        <input class="" type="hidden" name="id" value="<?= $this->e($product_manage->ma_san_pham) ?>">
                        <td style="text-align: center; vertical-align: middle;"><?= $this->e($product_manage->ma_san_pham) ?></td>
                        <td style="vertical-align: middle;"><a class="text-black" href="/detail?masp=<?= $product_manage->ma_san_pham ?>"><?= $this->e($product_manage->ten_san_pham) ?></a></td>
                        <td style="vertical-align: middle;"><?= $this->e(number_format($product_manage->gia_san_pham, 0, ',', '.')) ?> VNĐ</td>
                        ...
                        <td style="text-align: center; vertical-align: middle;"><?= $this->e($product_manage->ten_loai_san_pham) ?></td>
                        <td style="vertical-align: middle;"><?= $this->e($product_manage->mo_ta_san_pham) ?></td>
                        <td style="vertical-align: middle;"><?= $this->e($product_manage->created_at) ?></td>
                        <td style="text-align: center; vertical-align: middle;"><a href="/manage/<?= $this->e($product_manage->ma_san_pham) ?>" class="btn btn-xs btn-warning" style="padding: 3px 6px;">
                                <i alt="Edit" class="fa fa-edit"></i>
                            </a>
                        </td>
                        <td style="text-align: center; vertical-align: middle;">
                            <form class="delete" action="/manage/delete/<?= $this->e($product_manage->ma_san_pham) ?>" method="POST" style="display: inline;">
